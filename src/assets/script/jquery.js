  ...
  return (
    +(function(a) {
      ...
      a.fn.textcomplete = function(d, e) {
        ...
        return this.each(function() {
          var g = this,
            h = a(this),
            i = h.data("textComplete");
          if (
            (i ||
              (e || (e = {}),
              (e._oid = c++),
              (i = new a.fn.textcomplete.Completer(this, e)),
              h.data("textComplete", i)),
            "string" == typeof d)
          ) {
            if (!i) return;
            f.shift(),
              i[d].apply(i, f),
              "destroy" === d && h.removeData("textComplete");
          } else
            a.each(d, function(c) {
              a.each(["header", "footer", "placement", "maxCount"], function(
                a
              ) {
                c[a] &&
                  ((i.option[a] = c[a]),
                  b(a + "as a strategy param is deprecated. Use option."),
                  delete c[a]);
              });
            }),
              i.register(
                a.fn.textcomplete.Strategy.parse(d, { el: g, $el: h })
              );
        });
      };
    })(a),
    +(function(a) {
      ...
      function b(c, d) {
        if (
          ((this.$el = a(c)),
          (this.id = "textcomplete" + e++),
          (this.strategies = []),
          (this.views = []),
          (this.option = a.extend({}, b.defaults, d)),
          !(
        ...
        if (c === c.ownerDocument.activeElement) this.initialize();
        else {
          var g = this;
          this.$el.one("focus." + this.id, function() {
            g.initialize();
          }),
            (this.option.adapter && "CKEditor" != this.option.adapter) ||
              "undefined" == typeof CKEDITOR ||
              !this.$el.is("textarea") ||
              CKEDITOR.on("instanceReady", function(b) {
                -1 == a.inArray(b.editor.id, f) &&
                  (f.push(b.editor.id),
                  b.editor.on("focus", function(c) {
                    (g.$el = a(b.editor.editable().$)),
                      g.option.adapter ||
                        (g.option.adapter = a.fn.textcomplete.CKEditor),
                      (g.option.ckeditor_instance = b.editor),
                      g.initialize();
                  }));
              });
        }
        ...
        a.extend(b.prototype, {
          ...
          initialize: function() {
            ...
            if (
              ...
              for (var c = 0; c < window.frames.length; c++)
                if (
                  this.$el.prop("ownerDocument") === window.frames[c].document
                ) {
                  this.$iframe = a(window.frames[c].frameElement);
                  break;
                }
            this.dropdown = new a.fn.textcomplete.Dropdown(
              b,
              this,
              this.option
            );
              ...
              : ((e =
                  ...
                  this.$el.is("input[type=search]")
                    ? "number" == typeof b.selectionEnd
                      ...
                      : "IETextarea"
                    : "ContentEditable"),
                (d = a.fn.textcomplete[e])),
              (this.adapter = new d(b, this, this.option));
          },
          destroy: function() {
            this.$el.off("." + this.id),
          ...
          trigger: function(a, b) {
            this.dropdown || this.initialize(),
              null != a || (a = this.adapter.getTextFromHeadToCaret());
            var c = this._extractSearchQuery(a);
            if (c.length) {
              var d = c[1];
              if (b && this._term === d && "" !== d) return;
          ...
          select: function(a, b, c) {
            (this._term = null),
              this.adapter.select(a, b, c),
              this.fire("change").fire("textComplete:select", a, b),
              this.adapter.focus();
          },
          _clearAtNext: !0,
          _term: null,
          _extractSearchQuery: function(b) {
            for (var c = 0; c < this.strategies.length; c++) {
              var e = this.strategies[c],
                f = e.context(b);
              if (f || "" === f) {
                var g = a.isFunction(e.match) ? e.match(b) : e.match;
                d(f) && (b = f);
                var h = b.match(g);
                if (h) return [e, h[e.index], h];
              }
            }
            return [];
          },
          _search: c(function(a, b, c, d) {
            ...
            b.search(
              c,
              function(d, f) {
                e.dropdown.shown || e.dropdown.activate(),
                  e._clearAtNext && (e.dropdown.clear(), (e._clearAtNext = !1)),
                  e.dropdown.setPosition(e.adapter.getCaretPosition()),
                  e.dropdown.render(e._zip(d, b, c)),
                  f || (a(), (e._clearAtNext = !0));
              },
              d
            );
          }),
    ...
    +(function(a) {
      ...
      a.extend(b, {
        createElement: function(b) {
          ...
          var d = a("<ul></ul>")
            .addClass(b.dropdownClassName)
            .attr("id", "textcomplete-dropdown-" + b._oid)
            .css({
              display: "none",
              left: 0,
              position: "absolute",
        ...
        a.extend(b.prototype, {
          ...
          render: function(b) {
            ...
            if (b.length) {
              var e = b[0].strategy;
              e.id
                ? this.$el.attr("data-strategy", e.id)
                : this.$el.removeAttr("data-strategy"),
                this._renderHeader(d),
                this._renderFooter(d),
                c &&
                  (this._renderContents(c),
                  this._fitToBottom(),
                  this._fitToRight(),
              ...
              this.noResultsMessage
                ? this._renderNoResultsMessage(d)
          ...
          isEnter: function(a) {
            ...
            return (
              ...
              (13 === a.keyCode ||
                9 === a.keyCode ||
                (this.option.completeOnSpace === !0 && 32 === a.keyCode))
            );
          },
          isPageup: function(a) {
            return 33 === a.keyCode;
          ...
          _bindEvents: function() {
            this.$el.on(
              ...
              this.$el.on(
                "mouseover." + this.id,
                ".textcomplete-item",
                a.proxy(this._onMouseover, this)
              ),
              this.$inputEl.on(
                "keydown." + this.id,
                a.proxy(this._onKeydown, this)
              );
          },
          _onClick: function(b) {
            var c = a(b.target);
            b.preventDefault(),
              (b.originalEvent.keepTextCompleteDropdown = this.id),
              c.hasClass("textcomplete-item") ||
                (c = c.closest(".textcomplete-item"));
          ...
          _onMouseover: function(b) {
            ...
            b.preventDefault(),
              c.hasClass("textcomplete-item") ||
                (c = c.closest(".textcomplete-item")),
              (this._index = parseInt(c.data("index"), 10)),
              this._activateIndexedItem();
          },
          _onKeydown: function(b) {
            if (this.shown) {
              var c;
              switch (
                (a.isFunction(this.option.onKeydown) &&
                  (c = this.option.onKeydown(b, f)),
                null == c && (c = this._defaultKeydown(b)),
                c)
              ) {
                case f.KEY_UP:
          ...
          _pageup: function() {
            var b = 0,
              c =
                this._getActiveElement().position().top -
                this.$el.innerHeight();
            this.$el.children().each(function(d) {
              return a(this).position().top + a(this).outerHeight() > c
                ? ((b = d), !1)
                : void 0;
            }),
              (this._index = b),
          ...
          _getActiveElement: function() {
            return this.$el.children(
              ".textcomplete-item:nth(" + this._index + ")"
            );
          },
          _setScroll: function() {
            var a = this._getActiveElement(),
              ...
              e = this.$el.scrollTop();
            0 === this._index || this._index == this.data.length - 1 || 0 > b
              ? this.$el.scrollTop(b + e)
              : b + c > d && this.$el.scrollTop(b + c + e - d);
          },
          _buildContents: function(a) {
            var b,
              ...
              e,
              f = "";
            for (c = 0; c < a.length && this.data.length !== this.maxCount; c++)
              (b = a[c]),
                d(this.data, b) ||
                  ((e = this.data.length),
                  this.data.push(b),
                  (f +=
                    '<li class="textcomplete-item" data-index="' + e + '"><a>'),
                  (f += b.strategy.template(b.value, b.term)),
                  (f += "</a></li>"));
            return f;
          },
          ...
          _renderFooter: function(b) {
            if (this.footer) {
              this._$footer ||
                (this._$footer = a(
                  '<li class="textcomplete-footer"></li>'
                ).appendTo(this.$el));
          ...
          _renderNoResultsMessage: function(b) {
            if (this.noResultsMessage) {
              this._$noResultsMessage ||
                (this._$noResultsMessage = a(
                  '<li class="textcomplete-no-results-message"></li>'
                ).appendTo(this.$el));
              var c = a.isFunction(this.noResultsMessage)
                ? this.noResultsMessage(b)
                : this.noResultsMessage;
          ...
          _fitToBottom: function() {
            var a = c.scrollTop() + c.height(),
              b = this.$el.height();
            this.$el.position().top + b > a &&
              (this.completer.$iframe || this.$el.offset({ top: a - b }));
          },
          _fitToRight: function() {
            for (
              var a,
                b = this.option.rightEdgeOffset,
                d = this.$el.offset().left,
                e = this.$el.width(),
                f = c.width() - b;
              d + e > f &&
              (this.$el.offset({ left: d - b }),
              (a = this.$el.offset().left),
              !(a >= d));
          ...
          _applyPlacement: function(a) {
            return (
              -1 !== this.placement.indexOf("top")
                ...
                : ((a.bottom = "auto"), delete a.lineHeight),
              -1 !== this.placement.indexOf("absleft")
                ? (a.left = 0)
                : -1 !== this.placement.indexOf("absright") &&
                  ((a.right = 0), (a.left = "auto")),
              a
            );
          }
        }),
        (a.fn.textcomplete.Dropdown = b),
        a.extend(a.fn.textcomplete, f);
    })(a),
    +(function(a) {
      "use strict";
      function b(b) {
    ...
    +(function(a) {
      ...
      a.extend(b.prototype, {
        ...
        initialize: function(b, c, e) {
          (this.el = b),
            (this.$el = a(b)),
            (this.id = c.id + this.constructor.name),
            (this.completer = c),
            (this.option = e),
            this.option.debounce &&
              (this._onKeyup = d(this._onKeyup, this.option.debounce)),
            this._bindEvents();
        },
        destroy: function() {
          this.$el.off("." + this.id),
        ...
        getCaretPosition: function() {
          var b = this._getCaretRelativePosition(),
            c = this.$el.offset(),
            d = this.option.appendTo;
          if (d) {
            d instanceof a || (d = a(d));
            var e = d.offsetParent().offset();
            (c.top -= e.top), (c.left -= e.left);
          }
          return (b.top += c.top), (b.left += c.left), b;
        },
        focus: function() {
          this.$el.focus();
        },
        ...
        _onKeyup: function(a) {
          this._skipSearch(a) ||
            this.completer.trigger(this.getTextFromHeadToCaret(), !0);
        },
    ...
    +(function(a) {
      ...
      a.extend(b.prototype, a.fn.textcomplete.Adapter.prototype, {
        select: function(b, c, d) {
          var e,
            f = this.getTextFromHeadToCaret(),
            g = this.el.value.substring(this.el.selectionEnd),
            h = c.replace(b, d);
          "undefined" != typeof h &&
            (a.isArray(h) && ((g = h[1] + g), (h = h[0])),
            (e = a.isFunction(c.match) ? c.match(f) : c.match),
            (f = f.replace(e, h)),
            this.$el.val(f + g),
        ...
        _getCaretRelativePosition: function() {
          var b = a.fn.textcomplete.getCaretCoordinates(
            this.el,
            this.el.selectionStart
          );
          return {
            top: b.top + this._calculateLineHeight() - this.$el.scrollTop(),
            left: b.left - this.$el.scrollLeft(),
            lineHeight: this._calculateLineHeight()
          };
        },
        _calculateLineHeight: function() {
          var a = parseInt(this.$el.css("line-height"), 10);
          if (isNaN(a)) {
            var b = this.el.parentNode,
              c = document.createElement(this.el.nodeName),
              d = this.el.style;
            c.setAttribute(
              "style",
    ...
    +(function(a) {
      ...
      a.extend(b.prototype, a.fn.textcomplete.Textarea.prototype, {
        select: function(b, c, d) {
          var e,
            f = this.getTextFromHeadToCaret(),
            g = this.el.value.substring(f.length),
            h = c.replace(b, d);
          if ("undefined" != typeof h) {
            a.isArray(h) && ((g = h[1] + g), (h = h[0])),
              ...
              this.$el.val(f + g),
              this.el.focus();
            var i = this.el.createTextRange();
            i.collapse(!0),
              i.moveEnd("character", f.length),
              i.moveStart("character", f.length),
              i.select();
          }
        },
        getTextFromHeadToCaret: function() {
      ...
      a.extend(b.prototype, a.fn.textcomplete.Adapter.prototype, {
        select: function(b, c, d) {
          var e = this.getTextFromHeadToCaret(),
            f = this.el.ownerDocument.getSelection(),
            g = f.getRangeAt(0),
            h = g.cloneRange();
          h.selectNodeContents(g.startContainer);
          var i,
            j = h.toString(),
            k = j.substring(g.startOffset),
            l = c.replace(b, d);
          if ("undefined" != typeof l) {
            a.isArray(l) && ((k = l[1] + k), (l = l[0])),
              (i = a.isFunction(c.match) ? c.match(e) : c.match),
              (e = e.replace(i, l).replace(/ $/, "&nbsp")),
              g.selectNodeContents(g.startContainer),
              g.deleteContents();
            var m = this.el.ownerDocument.createElement("div");
            m.innerHTML = e;
            var n = this.el.ownerDocument.createElement("div");
            n.innerHTML = k;
            for (
              var o, p, q = this.el.ownerDocument.createDocumentFragment();
              (o = m.firstChild);

            )
              p = q.appendChild(o);
            for (; (o = n.firstChild); ) q.appendChild(o);
            g.insertNode(q),
              g.setStartAfter(p),
              g.collapse(!0),
              f.removeAllRanges(),
        ...
        _getCaretRelativePosition: function() {
          var b = this.el.ownerDocument
              ...
              .getRangeAt(0)
              .cloneRange(),
            c = b.endContainer.parentNode,
            d = this.el.ownerDocument.createElement("span");
          b.insertNode(d),
          ...
          var e = a(d),
            f = e.offset();
          if (
            ((f.left -= this.$el.offset().left),
            (f.top += e.height() - this.$el.offset().top),
            (f.lineHeight = e.height()),
            this.completer.$iframe)
          ) {
            var g = this.completer.$iframe.offset();
            (f.top += g.top),
              (f.left += g.left),
              (f.top -= a(
        ...
        getTextFromHeadToCaret: function() {
          var a = this.el.ownerDocument.getSelection().getRangeAt(0),
            b = a.cloneRange();
          return (
            b.selectNodeContents(a.startContainer),
            b.toString().substring(0, a.startOffset)
          );
        }
      }),
    ...
    +(function(a) {
      ...
      a.extend(b.prototype, a.fn.textcomplete.ContentEditable.prototype, {
        _bindEvents: function() {
          var b = this;
          this.option.ckeditor_instance.on(
            ...
            function(a) {
              ...
              return (
                b._onKeyup(c),
                b.completer.dropdown.shown && b._skipSearch(c) ? !1 : void 0
              );
            },
            null,
            null,
    ...
    (function(a) {
      function b(a, b, f) {
        ...
        var j = i.style,
          k = window.getComputedStyle ? getComputedStyle(a) : a.currentStyle;
        (j.whiteSpace = "pre-wrap"),
          "INPUT" !== a.nodeName && (j.wordWrap = "break-word"),
          (j.position = "absolute"),
          g || (j.visibility = "hidden"),
          c.forEach(function(a) {
            j[a] = k[a];
          }),
          e
            ? a.scrollHeight > parseInt(k.height) && (j.overflowY = "scroll")
            : (j.overflow = "hidden"),
          (i.textContent = a.value.substring(0, b)),
          "INPUT" === a.nodeName &&
            (i.textContent = i.textContent.replace(/\s/g, " "));
        var l = document.createElement("span");
        (l.textContent = a.value.substring(b) || "."), i.appendChild(l);
        var m = {
          top: l.offsetTop + parseInt(k.borderTopWidth),
          left: l.offsetLeft + parseInt(k.borderLeftWidth)
        };
        return (
          g ? (l.style.backgroundColor = "#aaa") : document.body.removeChild(i),
          m
        );
      }
      var c = [
        ...
        e = d && null != window.mozInnerScreenX;
      a.fn.textcomplete.getCaretCoordinates = b;
    })(a),
    a
  );
});
