          ...
          var Audio =
            ...
            (function() {
              function Audio(player) {
                ...
                this.audioPlayer.classList.add("audio");
                this.audioPlayer.innerHTML = Audio.getTemplate() + audioElement;
                ...
                [
                  {
                    ...
                    value: function initEvents() {
                      ...
                      this.player.addEventListener(
                        "loadedmetadata",
                        function() {
                          _this.totalTime.textContent = Audio.formatTime(
                  ...
                  },
                  {
                    ...
                    value: function updateProgress() {
                      ...
                      this.currentTime.textContent = Audio.formatTime(current);
                    }
                  },
                  {
                    key: "updateVolume",
                  ...
                  },
                  {
                    ...
                    value: function togglePlay() {
                      if (this.player.paused) {
                        this.playPause.attributes.d.value =
                  ...
                  },
                  {
                    ...
                    value: function directionAware() {
                      ...
                      if (window.innerHeight < 250) {
                        ...
                        this.audioPlayer.getBoundingClientRect().top < 154
                      ) {
